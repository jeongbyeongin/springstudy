...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("도로명주소 :" + academy.getAddress().getLoadadd());
		System.out.println("지번주소 :" + academy.getAddress().getJibynadd());
		System.out.println("전화번호 :" + academy.getAddress().getContact().getPhoneNo());
		System.out.println("팩스번호 :" + academy.getAddress().getContact().getFexNo());
