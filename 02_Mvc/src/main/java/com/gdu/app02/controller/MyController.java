...
public class MyController {
	...
	/*
		...
		3. 매개변수 : 요청에 응답에 따라 다르다. (요청이 필요한 경우 HttpServletRequest, 응답이 필요한 경우 HttpServletResponse 등)
	*/
	...
	*/
	...
	/*
		...
		@RequestMapping(value="list.do", method=RequestMethod.GET) 		value는 슬래시(/)로 시작하지 않아도 된다. 핸들러매핑이라는 애가 알아서 찾아준다
