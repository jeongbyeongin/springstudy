...
@RequestMapping("/board")	// 모든 mapping에 /board가 prefix(앞에)로 추가됩니다.
@Controller
public class BoardController {
	...
	/*
	@PostMapping("/add.do")
	public String add(HttpServletRequest request, Model model)	{	// 파라미터 받는 방법 HttpServletRequest , @RequestParam, BoardDTO board
		...
		model.addAttribute("board", boardService.addBoard(board));
