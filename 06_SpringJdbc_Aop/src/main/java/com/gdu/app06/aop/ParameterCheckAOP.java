...
public class ParameterCheckAOP {
	...
	public void paramLogging(JoinPoint joinPoint) {	// JoinPoint를 (컨트롤러의 모든 메소드)를 받아와서 PointCut(ParamCheck로 끝나는 메소드)에 해당하는 메소드
		
		// 모든 파라미터가 저장된 HttpServletRequest 가져오기(모든 파라미터는 HttpServletRequest에 저장되므로
