...
<script>
	$(function(){
		...
		$('#recordPerPage').on('change', function(){
			location.href = '${contextPath}/employees/change/record.do?recordPerPage=' + $(this).val();		// (change)바뀔 때 마다 Session에 recorde 올리기
		})
...
<body>
	...
	<div>
		<a href="${contextPath}/employees/search.form">사원 조회 화면으로 이동ㅡㅡ</a>
	</div>
