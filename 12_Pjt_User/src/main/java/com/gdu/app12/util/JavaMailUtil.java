...
public class JavaMailUtil {
	...
	public void sendJavaMail(String to, String title, String content) { // 받는사람, 제목, 내용
		
		try {
			
			// 이메일 전송을 위한 필수 속성을 Properties 객체로 만든다. ( appliction.properties 참고)
			...
			// 이메일을 보내는 계정 정보를 javax.mail.Session(자바메일의 세션)에 저장한다.
			...
			message.setRecipient(Message.RecipientType.TO, new InternetAddress(to)); // TO : 받는 사람 , CC : 참조해서 보내는 사람들, BCC : 숨은 참조
